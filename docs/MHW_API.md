...
Fields
	...
	•	stars (integer): Weakness level (1–3)
...
For Frontend Team
	...
	•	Convert stars into visual indicators (⭐ icons).
...
This document is an API contract.
	•	If API responses or data structures change,
this document must be updated.
	•	Frontend and algorithm logic depend on the structures defined here.
