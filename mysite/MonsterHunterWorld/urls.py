...
urlpatterns = [
    ...
    # Monsters
    # ==================================================
    path("api/v1/mhw/monsters/", MonsterListView.as_view(), name="mhw-monster-list"),
    path(
    ...
    path(
        "api/v1/mhw/monsters/<int:external_id>/",
    ...
    # Weapons
    # ==================================================
    path("api/v1/mhw/weapons/", WeaponListView.as_view(), name="mhw-weapon-list"),
    path(
    ...
    path(
        "api/v1/mhw/weapons/<int:external_id>/",
    ...
    # Skills
    # ==================================================
    path("api/v1/mhw/skills/", SkillListView.as_view(), name="mhw-skill-list"),
    path(
    ...
    path(
        "api/v1/mhw/skills/<int:external_id>/",
    ...
    # Armors
    # ==================================================
    path("api/v1/mhw/armors/", ArmorListView.as_view(), name="mhw-armor-list"),
    path(
    ...
    path(
        "api/v1/mhw/armors/<int:external_id>/",
    ...
    # Charms
    # ==================================================
    path("api/v1/mhw/charms/", CharmListView.as_view(), name="mhw-charm-list"),
    path(
    ...
    path(
        "api/v1/mhw/charms/<int:external_id>/",
    ...
    path(
        "api/v1/mhw/decorations/<int:external_id>/",
    ...
    # Builds
    # ==================================================
    path("api/v1/mhw/builds/", BuildListView.as_view(), name="mhw-build-list"),
    path(
